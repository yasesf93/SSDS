...
class FMNISTdel(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        """
        if self.train:
            img, delta, target = self.train_data[index],self.delta[index], self.train_labels[index]
        else:
            img, delta, target = self.test_data[index], self.delta[index], self.test_labels[index]
